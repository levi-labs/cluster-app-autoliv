                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody class="text-sm text-center">
                                            ...
                                            @php
                                                $no2 = 0;
                                            @endphp
                                            @foreach ($average as $vkey => $vvalue)
                                                <tr>
                                                    <td>{{ $no2 += 1 }}</td>
                                                    <td>{{ $vvalue[0]['nama'] }}</td>
                                                    <td>{{ number_format($vvalue[0]['penjualan'], 0, '.') }}</td>
                                                    <td>{{ $vvalue[1] }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    ...
                                    <table class="table table-bordered mb-0">
                                        <tbody class="text-center">
                                            ...
                                            <tr class="text-sm">
                                                ...
                                                <td>
                                                    @foreach ($cluster_1 as $c_1 => $c)
                                                        {{ $c[1] . ',' }}
                                                    @endforeach
                                                </td>
                                                <th rowspan="5" class="align-middle">{{ $count_c2 }}</th>
                                                <td>
                                                    @foreach ($cluster_2 as $c_2 => $cc)
                                                        {{ $cc[1] . ',' }}
                                                    @endforeach
                                                </td>
                                            </tr>
                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody class="text-sm text-center">
                                            ...
                                            @php
                                                ...
                                                $count_Iterasi2c2 = 0;
                                            @endphp
                                            @foreach ($newClusterss[0][0] as $vkn => $vnew)
                                                <tr>
                                                    <td>{{ $noIterasi2 += 1 }}</td>

                                                    @if ($vnew[0] == $vnew[2])
                                                        <td class="table-primary fw-bolder">{{ numFormat($vnew[0]) }}</td>
                                                    @else
                                                        <td>{{ numFormat($vnew[0]) }}</td>
                                                    @endif
                                                    @if ($vnew[1] == $vnew[2])
                                                        <td class="table-warning fw-bolder">{{ numFormat($vnew[1]) }}</td>
                                                    @else
                                                        <td>{{ numFormat($vnew[1]) }}</td>
                                                    @endif
                                                    @if ($vnew[0] == $vnew[2])
                                    ...
                                    <table class="table table-bordered mb-0">
                                        <tbody class="text-center">
                                            ...
                                            <tr class="text-sm">
                                                ...
                                                <td>
                                                    @foreach ($newClusterss[3][0] as $nnc_1 => $nnc)
                                                        {{ $nnc[1] . ',' }}
                                                    @endforeach
                                                </td>
                                                <th rowspan="5" class="align-middle">{{ $count_Iterasi2c2 }}</th>
                                                <td>
                                                    @foreach ($newClusterss[4][0] as $nnc_2 => $nnc)
                                                        {{ $nnc[1] . ',' }}
                                                    @endforeach
                                                </td>
                                            </tr>
                                ...
                                <div class="table-responsive p-2">
                                    <table class="table table-bordered mb-0">
                                        <tbody class="text-center">
                                            ...
                                            <tr class="text-sm">
                                                ...
                                                <td>
                                                    {{-- @php
                                                        dd($newClusterss);
                                                    @endphp --}}
                                                    @foreach ($newClusterss[3][0] as $nc_1 => $nc1)
                                                        {{ $nc1[0] . ',' }}
                                                        @php
                                                            // dd($newClusterss);
                                                            $sum_2c1 += $nc1[0];
                                                ...
                                                <th rowspan="5" class="align-middle">{{ $count_Iterasi2c2 }}</th>
                                                <td>
                                                    @foreach ($newClusterss[4][0] as $nc_2 => $nc2)
                                                        {{ numFormat($nc2[0]) . ',' }}
                                                        @php
                                                            $sum_2c2 += $nc2[0];
                                                        @endphp
                                            ...
                                            <tr>
                                                <td>{{ numFormat($sum_2c1) }}</td>
                                                <td>{{ numFormat($sum_2c2) }}</td>
                                            </tr>

                                            <tr>
                                                <td>{{ numFormat($sum_2c1) . ' / ' . $count_Iterasi2c1 . ' = ' . numFormat($sum_2c1 / $count_Iterasi2c1) }}
                                                </td>
                                                <td>{{ numFormat($sum_2c2) . ' / ' . $count_Iterasi2c2 . ' = ' . numFormat($sum_2c2 / $count_Iterasi2c2) }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody class="text-sm text-center">
                                            ...
                                            @foreach ($newClusterss[0][0] as $vkn => $vnew)
                                                <tr>
                                                    ...
                                                    @endif
                                                    @if ($vnew[0] == $vnew[2])
                                                        <td class="table-primary fw-bolder">{{ $vnew[2] }}</td>
                                                    @elseif ($vnew[1] == $vnew[2])
                                                        <td class="table-warning fw-bolder">{{ $vnew[2] }}
                                                        </td>
                                                    @endif
                                                    @if ($vnew[3] == 'C1')
                                                        @php
                                    ...
                                    <table class="table table-bordered mb-0">
                                        <tbody class="text-center">
                                            ...
                                            <tr class="text-sm">
                                                ...
                                                <td>
                                                    @foreach ($newClusterss[3][1] as $nnc_1 => $nnc)
                                                        {{ $nnc[1] . ',' }}
                                                    @endforeach
                                                </td>
                                                <th rowspan="5" class="align-middle">{{ $count_Iterasi2c2 }}</th>
                                                <td>
                                                    @foreach ($newClusterss[4][1] as $nnc_2 => $nnc)
                                                        {{ $nnc[1] . ',' }}
                                                    @endforeach
                                                </td>
                                            </tr>
                                ...
                                <div class="table-responsive p-2">
                                    <table class="table table-bordered mb-0">
                                        <tbody class="text-center">
                                            ...
                                            <tr class="text-sm">
                                                ...
                                                <td>
                                                    {{-- @php
                                                        dd($newClusterss);
                                                    @endphp --}}
                                                    @foreach ($newClusterss[3][1] as $nc_1 => $nc1)
                                                        {{ numFormat($nc1[0]) . ',' }}
                                                        @php
                                                            // dd($newClusterss);
                                                            $sum_3c1 += $nc1[0];
                                                ...
                                                <td>
                                                    @foreach ($newClusterss[4][1] as $nc_2 => $nc2)
                                                        {{ numFormat($nc2[0]) . ',' }}
                                                        @php
                                                            $sum_3c2 += $nc2[0];
                                                        @endphp
                                            ...
                                            @endphp --}}
                                            <tr>
                                                <td>{{ numFormat($sum_3c1) }}</td>
                                                <td>{{ numFormat($sum_3c2) }}</td>
                                            </tr>

                                            <tr>
                                                <td>{{ numFormat($sum_3c1) . ' / ' . $count_Iterasi3c1 . ' = ' . numFormat($sum_3c1 / $count_Iterasi3c1) }}
                                                </td>
                                                <td>{{ numFormat($sum_3c2) . ' / ' . $count_Iterasi3c2 . ' = ' . numFormat($sum_3c2 / $count_Iterasi3c2) }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
