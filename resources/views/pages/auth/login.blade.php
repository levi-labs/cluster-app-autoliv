...
<head>
    ...
    <title>{{ $title ?? 'Login AUTOLIV' }}</title>
    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    {{-- <div class="auth-logo">
                        <a href="{{ url('login') }}"><img src="{{ asset('assets/logo.png') }}" width="200px"
                                height="300px;"> </a>
                    </div> --}}
                    <a href="{{ url('login') }}"><img src="{{ asset('assets/logo.png') }}" width="100vh"
                            height="100vh"> </a>
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right">
                    ...
                    <div class="my-image">
                        <img src="{{ asset('assets/static/images/samples/architecture1.jpg') }}" alt="">
                    </div>
