                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form form-horizontal" method="POST"
                                action="{{ url('barang-keluar/update/' . $bKeluar->id) }}" autocomplete="off"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="first-name-horizontal" class="form-control"
                                                name="kode_barang_keluar" placeholder=""
                                                value="{{ $bKeluar->kode_barang_keluar }}" readonly>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="number" id="quantity_keluar" class="form-control"
                                                name="quantity_keluar" min="0" value="{{ $bKeluar->qty_keluar }}">
                                        ...
                                        <div class="col-md-8 form-group">
                                            ...
                                            <select class="form-select" id="barang" name="barang">
                                                ...
                                                @foreach ($barang as $brg)
                                                    <option {{ $brg->id == $bKeluar->barang_id ? 'selected' : '' }}
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="number" id="harga_jual" class="form-control" name="harga_jual"
                                                placeholder="0" min="0" value="{{ $bKeluar->harga_jual }}">
                                            @error('harga_jual')
                                                <span class="text-sm text-danger mt-2">{{ $message }}</span>
                                            @enderror
                                        </div>
